  ...
  <v-row justify="center" align="center">
    <v-col cols="12" sm="8" md="6">
      ...
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn color="primary" nuxt to="/sample/inspire"> Continue </v-btn>
        </v-card-actions>
      </v-card>
    </v-col>
  </v-row>
...
<script>
import NuxtLogo from "/components/sample/NuxtLogo";
import VuetifyLogo from "/components/sample/VuetifyLogo";
export default {
  name: "IndexPage",
  layout: "sample/default",
  components: {
    NuxtLogo,
    VuetifyLogo,
  },
